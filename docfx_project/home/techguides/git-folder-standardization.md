...
| client_files/h2db          | model-bank-database-h2                   | *.zip                                                        | *.zip                                                                                                                                                                                           | db.properties   file should be included in the zip file . The format of db.properties should   be as follows: db_name=TAFJDB -> without extension .mv.db or .h2.db      clientdb_user=t24 -> db username      clientdb_pass=t24 -> db password                                                                        |
| client_files/sqldb         | model-bank-database-sqlserver            | *.bak                                                        | *.zip                                                                                                                                                                                           | db.properties file   should be included in the zip file . The format of db.properties should be as   follows: db_name=UTPSQL2016 -> without extension names      clientdb_user=t24 -> db username      clientdb_pass=t24 -> db password                                                                               |
...
| addons                     | t24-Addons                               | *.zip                                                        | *.zip                                                                                                                                                                                           | environment file can be provided along with the jars/wars   which contains JAVA_OPTS that can to be added in the appserver startup. If   only environment file inside the zip is provded the JAVA_OPTS will be added   to the appserver without copying any war/jar files                                             |
...
| N/A                        | t24-jars                                 | *.zip                                                        | *.zip                                                                                                                                                                                           |        zip of multiple folders containing jars. For eg: t24lib, l3lib. Note: We   use the folders t24lib and l3lib for core and l3 libraries respectively.   Hence the same naming convention has to be used for the artifacts.eg:       \|24tcdjars.zip        \|_t24lib        \|_l3lib        \|_abclib        ... |
| client_files/localjars     | t24-l3-java                              |                                                              |                                                                                                                                                                                                 | zip of l3libraries.   Eg:      tcdl3.zip         \|_a1.jar         \|_a2.jar         \|_a3.jar         ....                                                                                                                                                                                                           |
...
| wsdl                       | wsdl                                     |                                                              |                                                                                                                                                                                                 | N/A                                                                                                                                                                                                                                                                                                                   |
| client_files/localjars/ext | tafj-ext-jars                            | zip of jars                                                  | zip of jars                                                                                                                                                                                     |        zip of l3libraries. Eg:      tafjext.zip         \|_a1.jar         \|_a2.jar         \|_a3.jar         ....                                                                                                                                                                                                    |
