...
|Endpoint URL          | The Endpoint URL will be: <br /> * **opened** in a new tab of your browser when the Endpoint Description is clicked, if the type is clickable. <br /> * **copied**, if the type is copyable. <br /> * automatically **downloaded**, if it is a downloadable type. |
|Endpoint Type          | In order to apply above actions, a type must be added for each endpoint, based on how you want to be displayed or used: clickable, copyable and downloadable.  |
...
<br>
 ...
 ![multiple endpoints same file display](./images/endpoints-deployed.png)
