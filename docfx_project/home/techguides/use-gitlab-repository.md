...
> Important: T24 Updates must be packaged as .zip of .zip file while we are deploying it through git repository (the parent zip file name can be anything). Example:
