...
- The **ArtifactoryKey** can be taken from TCD portal (go to General and take the value of ARTIFACTORY_KEY record):
...
-  concatenate to it the name of the binary that should be uploaded in artifactory (example: http://localhost/artifactory/Repo/DevStream/configuration_stage/T24Updates.zip)
...
![](./images/components-and-products-localcompomentpath.png)

> [!Note]
> Open source doesn’t support multiple file upload at a time, therefore you need to upload the required binaries one by one.

Example:     curl -H "X-JFrog-Art-Api:<AKCp5dKYyM9WMoiacim9yedAZfG6gLwwcYugPmzZhqHkdRe6ex6pZZnRMteQqedLE9Q3qds6V>" -X PUT "<https://1dtk4nz95tssg-artifactory.temenos.cloud/artifactory/repo-1dtk4nz95tssg/dev_stream/demo_stage/t24-jars>" -T <C:\Users\Temenos\Desktop\Artifactory\t24-jars-63688104355895.zip>
